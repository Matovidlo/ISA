...
private:
  unsigned packet_size;        // in Bytes -s param 56B ICMP or UDP 64B
  double loss_interval;   // in seconds -t param
  unsigned send_interval;      // in ms -i param
  double wait_interval;   // in seconds -w param
  unsigned udp_port;           // specification of UDP port
  unsigned listen_port;        // specification of listening UDP port
